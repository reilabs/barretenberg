...
ADDED_FLAGS="-DTESTING=0 -DOMP_MULTITHREADING=OFF -DCMAKE_TOOLCHAIN_FILE=./cmake/toolchains/ios.cmake -DPLATFORM=OS64"

# Build native.
cmake --preset $PRESET -DCMAKE_BUILD_TYPE=RelWithDebInfo -DMULTITHREADING=ON $ADDED_FLAGS
