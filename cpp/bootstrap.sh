...
# Build native.
cmake --preset $PRESET -DCMAKE_BUILD_TYPE=Release -DMULTITHREADING=OFF -DOMP_MULTITHREADING=OFF -DCMAKE_TOOLCHAIN_FILE=./cmake/toolchains/ios.cmake -DPLATFORM=OS64
